 ...
 * once created — the generated invite code with a copy-to-clipboard action.
 *
 * No business logic lives here — {@link RoomService} owns the HTTP call, this component only
 * orchestrates form state and presentation.
 */
@Component({
